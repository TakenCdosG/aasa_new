...
!function (a, b, c, d, e) {
    ...
    function H(a, b, c) {
        ...
        if (e && (!d.l || d.l.W !== e.width || d.l.H !== e.height || d.l.r !== e.ratio || d.l.w !== b.w || d.l.h !== b.h || d.l.m !== c)) {
            ...
            }), d.l = {W: e.width, H: e.height, r: e.ratio, w: b.w, h: b.h, m: c}
        }
        return !0
    }
    ...
    function U(a, b) {
        ...
        "undefined" != typeof b.overPos && b.overPos !== b.pos && (e = b.overPos, f = function () {
            U(a, d.extend({}, b, {overPos: b.pos, time: Math.max(Lc, b.time / 2)}))
        });
    ...
    function Y(a, b) {
        function c(c, d) {
            A = !0, j = l = c._x, q = c._now, p = [[q, j]], m = n = D.noMove || d ? 0 : u(a, (b.getPos || g)(), b._001), (b.onStart || g).call(B, c)
        }
        ...
        function i(e) {
            if (!D.noSwipe || !e.moved) {
                ...
                u = h(n, s, t);
                var H = k - l, I = H >= 0, J = r - C, K = J > Kc, L = !K && n !== m && u === n;
    ...
    function Z(a, b) {
        ...
        return h[Hc] && h[Hc](Jc, function (a) {
            var h = a.wheelDeltaY || -1 * a.deltaY || 0, j = a.wheelDeltaX || -1 * a.deltaX || 0, k = Math.abs(j) > Math.abs(h), l = T(0 > j), m = e === l, n = d.now(), o = Kc > n - f;
    ...
    var bb = "fotorama", cb = "fullscreen", db = bb + "__wrap", eb = db + "--css2", fb = db + "--css3", gb = db + "--video", hb = db + "--fade", ib = db + "--slide", jb = db + "--no-controls", kb = db + "--no-shadows", lb = db + "--pan-y", mb = db + "--rtl", nb = db + "--only-active", ob = bb + "__stage", pb = ob + "__frame", qb = pb + "--video", rb = ob + "__shaft", sb = bb + "__grab", tb = bb + "__pointer", ub = bb + "__arr", vb = ub + "--disabled", wb = ub + "--prev", xb = ub + "--next", yb = bb + "__nav", zb = yb + "-wrap", Ab = yb + "__shaft", Bb = yb + "--dots", Cb = yb + "--thumbs", Db = yb + "__frame", Eb = Db + "--dot", Fb = Db + "--thumb", Gb = bb + "__fade", Hb = Gb + "-front", Ib = Gb + "-rear", Jb = bb + "__shadow", Kb = Jb + "s", Lb = Kb + "--left", Mb = Kb + "--right", Nb = bb + "__active", Ob = bb + "__select", Pb = bb + "--hidden", Qb = bb + "--fullscreen", Rb = bb + "__fullscreen-icon", Sb = bb + "__error", Tb = bb + "__loading", Ub = bb + "__loaded", Vb = Ub + "--full", Wb = Ub + "--img", Xb = bb + "__grabbing", Yb = bb + "__img", Zb = Yb + "--full", $b = bb + "__dot", _b = bb + "__thumb", ac = _b + "-border", bc = bb + "__html", cc = bb + "__video", dc = cc + "-play", ec = cc + "-close", fc = bb + "__caption", gc = bb + "__caption__wrap", hc = bb + "__spinner", ic = d && d.fn.jquery.split(".");
    ...
    if ("undefined" != typeof b.cancelFullScreen)lc.ok = !0; else for (var nc = 0, oc = mc.length; oc > nc; nc++)if (lc.prefix = mc[nc], "undefined" != typeof b[lc.prefix + "CancelFullScreen"]) {
        lc.ok = !0;
        break
    }
    ...
    var pc, qc = {
        ...
        hwaccel: !0
    }, rc = {top: "auto", left: "auto", className: ""};
    !function (a, b) {
        pc = b()
    }(this, function () {
        function a(a, c) {
    ...
    jQuery.Fotorama = function (a, e) {
        ...
        function g(a) {
            var b = "keydown." + bb, c = "keydown." + bb + Wd, d = "resize." + bb + Wd;
        ...
        function w() {
            ...
            var a = {add: [], remove: []};
            md > 1 ? (zd = e.nav, Bd = "top" === e.navposition, a.remove.push(Ob), he.toggle(e.arrows)) : (zd = !1, he.hide()), cc(), od = new pc(d.extend(qc, e.spinner, rc, {direction: Kd ? -1 : 1})), wc(), xc(), e.autoplay && s(e.autoplay), Fd = m(e.thumbwidth) || Pc, Gd = m(e.thumbheight) || Pc, ye.ok = Ae.ok = e.trackpad && !Gc, n(), Vc(e, !0), Ad = "thumbs" === zd, Ad ? (jc(md, "navThumb"), nd = me, Ud = Uc, I(_d, d.Fotorama.jst.style({
                w: Fd,
                h: Gd,
        ...
        function mc(a) {
            Hb(a, "stage", function (a, b, c, f, g, h) {
                if (f) {
                    Ce[Sc][x(b)] = f.css(d.extend({left: Ed ? 0 : q(b, we.w, e.margin, sd)}, Ed && l(0))), E(f[0]) && (f.appendTo(de), bd(c.$video));
                    var i = c.fit || e.fit;
        ...
        function nc(a, b) {
            if ("thumbs" === zd && !isNaN(a)) {
                var c = -a, e = -a + we.nw;
                me.each(function () {
                    var a = d(this), f = a.data(), g = f.eq, h = {h: Gd}, i = "cover";
        ...
        function oc(a, b, c) {
            if (!oc[c]) {
                ...
                b.append(a.filter(function () {
                    for (var a, b = d(this), c = b.data(), e = 0, f = ld.length; f > e; e++)if (c.data === ld[e]) {
                        a = !0, c.eq = e;
                        break
                    }
                    return a || b.remove() && !1
                    ...
                    if (f) {
                        var a = d(this), b = a.data(), c = Math.round(Gd * b.data.thumbratio) || Fd;
        ...
        function Bc(a) {
            ...
            U(ne, {time: .9 * a, pos: b.l, width: b.w - 2 * e.thumbborderwidth})
        }

        function Fc(a) {
            var b = ld[a.guessIndex][Ud];
            if (b) {
                var c = ze.min !== ze.max, d = c && Ac(Vd.activeFrame[Ud]), e = c && (a.keep && Fc.l ? Fc.l : h((a.coo || we.nw / 2) - Ac(b).c, d.min, d.max)), f = c && h(e, ze.min, ze.max), g = .9 * a.time;
                U(ke, {
        ...
        function $c() {
            ...
            var a = ue, b = Vd.activeFrame[Sc].data();
            F(function () {
                return b.state || a !== ue
            }, function () {
        ...
        function ed(a) {
            clearTimeout(ed.t), e.clicktransition && e.clicktransition !== e.transition ? (Id = e.transition, Vd.setOptions({transition: e.clicktransition}), ed.t = setTimeout(function () {
                Vd.show(a)
            }, 10)) : Vd.show(a)
        }
        ...
        function hd(a, b) {
            ...
            ed({index: c, slow: a.altKey, user: !0, coo: a._x - je.offset().left, time: b})
        }
        ...
        function id() {
            ...
            if (md) {
                if (jd())return;
                pd && bd(pd, !0), rd = [], Mc(Sc), Vd.show({index: ue, time: 0, reset: id.ok}), Vd.resize()
            } else Vd.destroy();
            id.ok = !0
        }
        ...
        be[Sc] = d(M(pb)), be[Uc] = d(M(Db + " " + Fb, M(_b))), be[Tc] = d(M(Db + " " + Eb, M($b))), Be[Sc] = [], Be[Uc] = [], Be[Tc] = [], Ce[Sc] = {}, be.addClass(Cc ? fb : eb), $d.fotorama = this, Vd.startAutoplay = function (a) {
            ...
            var c = Math.abs(ud - td), d = v(a.time, function () {
            ...
            var g = Vd.show.onEnd = function (b) {
                if (!g.ok) {
                    if (g.ok = !0, b || Oc(!0), !a.reset && (Wc("showend", {user: a.user}), !b && Id && Id !== e.transition))return Vd.setOptions({transition: Id}), void(Id = !1);
                    ic(), Jb(rd, "stage"), gd("go", !1), xc(), dd(), Zc(), $c()
                }
            };
            if (Ed) {
                var i = qd[Sc], j = ue !== ud ? ld[ud][Sc] : null;
                V(i, j, ee, {time: d, method: e.transition, onEnd: g}, Ee)
            } else U(de, {pos: -q(td, we.w, e.margin, sd), overPos: f, time: d, onEnd: g, _001: !0});
            if (wc(), zd) {
                Hc();
            ...
            var b = arguments[1] || 0, c = arguments[2], d = we.width, f = we.height, g = we.ratio, i = yc.height() - (zd ? je.height() : 0);
            return p(d) && (be.addClass(nb).css({
                ...
                be.removeClass(nb)
            }), Oc(), zd && (je.stop().animate({width: we.nw}, b), Fc({
                guessIndex: ue,
                time: b,
                keep: !0
            ...
            var a = Vd.activeFrame, b = a.video, c = ue;
            ...
            onStart: Xc, onMove: function (a, b) {
                ad(ce, b.edge)
                ...
                if (a.moved || b && a.pos !== a.newPos && !a.control) {
                    ...
                    Vd.show({index: c, time: Ed ? Hd : a.time, overPos: a.overPos, user: !0})
                } else a.aborted || a.control || fd(a.startEvent, b)
            }, _001: !0, timeLow: 1, timeHigh: 1, friction: 2, select: "." + Ob + ", ." + Ob + " *", $wrap: ce
        }), ze = Y(ke, {
            onStart: Xc, onMove: function (a, b) {
                ad(je, b.edge)
            }, onTouchEnd: Yc, onEnd: function (a) {
                ...
                if (a.moved)a.pos !== a.newPos ? (Pd = !0, U(ke, {
                    ...
                    overPos: a.overPos,
                    onEnd: b
                }), nc(a.newPos), Jd && ad(je, J(a.newPos, ze.min, ze.max))) : b(); else {
                    var c = a.$target.closest("." + Db, ke)[0];
                    c && hd.call(c, a.startEvent)
                }
            }, timeLow: .5, timeHigh: 2, friction: 5, $wrap: je
        }), ye = Z(ce, {
            shift: !0, onEnd: function (a, b) {
                Xc(), Yc(), Vd.show({index: b, slow: a.altKey})
            }
        }), Ae = Z(je, {
            onEnd: function (a, b) {
                Xc(), Yc();
            ...
            S(a), ed({index: he.index(this) ? ">" : "<", slow: a.altKey, user: !0})
        }, {
            onStart: function () {
                Xc(), xe.control = !0
            }, onTouchEnd: Yc
        ...
        var c = "", d = (jc.escape, Array.prototype.join);
