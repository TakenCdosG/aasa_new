    ...
    <?php if (!aaap_event_registration($node->nid)) { ?>
        <div id="header_event">
            <div id="content_header_event">
                ...
                <div
                    id="city_state"><?php if (!empty($node->field_city) and !empty($node->field_state_province['und'][0]['value'])) {
                ...
                <div id="location_event"><?php if (!empty($node->field_event_location)) {
                ...
                <div id="short_description_event"><?php if (!empty($node->field_short_description)) {
        ...
        <div class="content"<?php print $content_attributes; ?>>
            <div id="body_event"><?php if (!empty($node->body)) {
