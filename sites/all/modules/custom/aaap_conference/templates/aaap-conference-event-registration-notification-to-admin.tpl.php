                                        ...
                                        <tr>
                                            ...
                                            <td width="98%">
                                                <div style="padding-left:1em">
                                                    <span style="font-size:large">AASA Meeting: New Registrant Notification - <?php echo $params["node_title"]; ?></span><br>
                                                </div>
                                            </td>
                                            <td nowrap="" width="121">
                                        ...
                                        <tr>
                                            ...
                                            <td width="98%">
                                                ...
                                                <?php if (isset($params["order_download_link"])): ?>
                                                    <br>
                                                    <a href="<?php echo $params["order_download_link"]; ?>" target='_blank'> Click here to download their <?php echo $params["order_download_link_type"]; ?></a>
                                                <?php endif; ?>
                                            </td>
                                            <td></td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <table width="100%" cellspacing="0" cellpadding="0" width="100%" style="font-family:verdana,arial,helvetica;font-size:small">
                                                    <tbody>
                                                        <?php if (isset($params["payee"])): ?>
                                                            <tr>
                                                                <td nowrap="">
                                                                    <b>Payee: </b>
                                                                </td>
                                                                <td width="98%">
                                                                    <?php echo $params["payee"]; ?>             
                                                                </td>
                                                            </tr>
                                                        <?php endif; ?>
                                                        <tr>
                                                    ...
                                                    <td colspan="2">
                                                        <table border="0" cellpadding="1" cellspacing="0" width="100%" style="font-family:verdana,arial,helvetica;font-size:small">
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td colspan="2">
                                                                        <b>Items added to their registration:</b>
                                                                        <table width="100%" style="font-family: verdana, arial, helvetica; font-size: small;">
                                                                            <?php $total = 0; ?>
                                                    ...
                                                    <td colspan="2">
                                                        <table border="0" cellpadding="1" cellspacing="0" width="100%" style="font-family:verdana,arial,helvetica;font-size:small">
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td colspan="2">
                                                                        <b>Items Removed From Their Registration:</b>
                                                                        <table width="100%" style="font-family: verdana, arial, helvetica; font-size: small;">
