                                ...
                                <table width="100%" style="font-family:verdana,arial,helvetica;font-size:small">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td width="98%">
                                                <div style="padding-left:1em">
                                                    <span style="font-size:large"><?php echo $params["site_name"]; ?> Meeting: New Update Registrant Notification - <?php echo $params["node_title"]; ?></span><br>
                                                </div>
                                            </td>
                                            <td nowrap="" width="121">
                                        ...
                                        <tr>
                                            ...
                                            <td width="98%">
                                                <p>
                                                    A registrant has updated their conference registration(<?php echo ucwords($params["node_title"]); ?>). Click here to see the registration information: <a href="<?php echo $params["admin_node_url"]; ?>"><?php echo ucwords($params["node_title"]); ?></a>
                                                </p>
                                            </td>
                                            <td></td>
                                        </tr>
