                                ...
                                <table width="100%" style="font-family:verdana,arial,helvetica;font-size:small">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td width="98%">
                                                <div style="padding-left:1em">
                                                    <span style="font-size:large">Thank you for registering for the <?php echo $params["site_name"]; ?> <?php echo $params["node_title"]; ?></span><br>
                                                </div>
                                            </td>
                                            <td nowrap="" width="121">
                                        ...
                                        <tr>
                                            <td></td>
                                            <td width="98%">
                                                <?php if (isset($params["payment_method"])): ?>
                                                    <?php if ($params["payment_method"] == 'mail_check'): ?>
                                                        We have received notification you will pay registration in the form of a check.<br/>
                                                    <?php endif; ?>
                                                <?php endif; ?>
                                                You can view more information about the event here: <a href="<?php echo $params["node_url"]; ?>"><?php echo $params["node_title"]; ?></a>
                                                <?php if (isset($params["order_download_link"])): ?>
                                                    <br>
                                                    <a href="<?php echo $params["order_download_link"]; ?>"> Click here to download your <?php echo $params["order_download_link_type"]; ?></a>
                                                <?php endif; ?>
                                            </td>
                                            <td></td>
                                        </tr>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td colspan="2">
                                                                        ...
                                                                        <table width="100%" style="font-family: verdana, arial, helvetica; font-size: small;">
                                                                            <?php $total = 0; ?>
                                                                            <?php foreach ($params["added"] as $key => $product_added): ?>
                                                                                <?php $payment_method = ""; ?>
                                                                                ...
                                                                                <?php $total = $total + floatval($product_added->sell_price); ?>
                                                                            <?php endforeach; ?>
                                                                            <?php if (isset($params["added_subtotal"])): ?>
                                                                                <tr>
                                                                                    <td valign="top" nowrap="nowrap">
                                                                                        <b>Subtotal</b>
                                                                                    </td>
                                                                                    <td width="98%">
                                                                                        <b>$<?php echo number_format((float) $params["added_subtotal"]["amount"], 2, '.', ''); ?></b><br/>
                                                                                    </td>
                                                                                </tr>
                                                                            <?php endif; ?>

                                                                            <?php $calculate = FALSE; ?>
                                                                            <?php if (isset($params["added_subtotal"]["amount"]) && isset($params["added_coupon"])): ?>
                                                                                <?php $total = floatval($params["added_subtotal"]["amount"]); ?>
                                                                                <?php $calculate = TRUE; ?>
                                                                            <?php endif; ?>    

                                                                            <?php if (isset($params["added_coupon"])): ?>
                                                                                <?php foreach ($params["added_coupon"] as $added_coupon): ?>
                                                                                    <tr>
                                                                                        <td valign="top" nowrap="nowrap">
                                                                                            <b><?php echo $added_coupon["title"]; ?></b>
                                                                                        </td>
                                                                                        <td width="98%">
                                                                                            <b><span>-$<?php echo number_format(((float) $added_coupon["amount"] * -1), 2, '.', ''); ?></span></b><br/>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <?php if ($calculate): ?>
                                                                                        <?php $total = $total + floatval($added_coupon["amount"]); ?>
                                                                                    <?php endif; ?>
                                                                                <?php endforeach; ?>
                                                                            <?php endif; ?>
                                                                ...
                                                                <tr>
                                                                    <td colspan="2">
                                                                        ...
                                                                        <table width="100%" style="font-family: verdana, arial, helvetica; font-size: small;">
                                                                            <?php $date = ""; ?>
                                                                            <?php $total = 0; ?>
                                                                            <?php foreach ($params["to_add"] as $key => $product_to_add): ?>
                                                                                <?php $payment_method = ""; ?>
                                                                            ...
                                                                            <?php endforeach; ?>
                                                                            <?php if (isset($params["to_add_subtotal"])): ?>
                                                                                <tr>
                                                                                    <td valign="top" nowrap="nowrap">
                                                                                        <b>Subtotal</b>
                                                                                    </td>
                                                                                    <td width="98%">
                                                                                        <b>$<?php echo number_format((float) $params["to_add_subtotal"]["amount"], 2, '.', ''); ?></b><br/>
                                                                                    </td>
                                                                                </tr>
                                                                                <?php $total = floatval($params["to_add_subtotal"]["amount"]); ?>
                                                                            <?php endif; ?>


                                                                            <?php $calculate = FALSE; ?>
                                                                            <?php if (isset($params["to_add_subtotal"]["amount"]) && isset($params["to_add_coupon"])): ?>
                                                                                <?php $total = floatval($params["to_add_subtotal"]["amount"]); ?>
                                                                                <?php $calculate = TRUE; ?>
                                                                            <?php endif; ?>    

                                                                            <?php if (isset($params["to_add_coupon"])): ?>
                                                                                <?php foreach ($params["to_add_coupon"] as $to_add_coupon): ?>
                                                                                    <tr>
                                                                                        <td valign="top" nowrap="nowrap">
                                                                                            <b><?php echo $to_add_coupon["title"]; ?></b>
                                                                                        </td>
                                                                                        <td width="98%">
                                                                                            <b><span>-$<?php echo number_format(((float) $to_add_coupon["amount"] * -1), 2, '.', ''); ?></span></b><br/>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <?php if ($calculate): ?>
                                                                                        <?php $total = $total + floatval($to_add_coupon["amount"]); ?>
                                                                                    <?php endif; ?>
                                                                                <?php endforeach; ?>
                                                                            <?php endif; ?>
